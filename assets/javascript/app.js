$(document).ready(function () {
	var movies = ["jaws", "beetlejuice", "toy story", "young frankenstein", "tommy boy", "gremlins", "star wars", "dumb and dumber"];

	// Add buttons for original movies list / array
	...
	// Adds a button for movie entered
	...
	// Transfers gifs from api to html
	$("button").on("click", function () {
		var movie = $(this).attr("data-movie");
		var queryURL = "https://api.giphy.com/v1/gifs/search?q=" +
			movie + "&api_key=nJew95ZEmNOcbFTXViTT7Z3MDbAVdiBO&limit=10"
